...
/*
   ...
   public class StartupCommon {
    ...
    java.lang.NoClassDefFoundError: net/minecraft/client/renderer/tileentity/TileEntitySpecialRenderer
  	at mineEngine.CommonProxy.preInit(CommonProxy.java:25) ~[CommonProxy.class:?]
...
@Mod(modid = mineEngine.MODID, version = mineEngine.VERSION)
public class mineEngine {

    public static final String MODID = "mineengine";
    public static final String VERSION = "1.12.2a";


    // The instance of your mod that Forge uses.  Optional.
    @Mod.Instance(mineEngine.MODID)
    public static mineEngine instance;

    // Says where the client and server 'proxy' code is loaded.
    @SidedProxy(clientSide = "mineengine.ClientOnlyProxy", serverSide = "mineengine.DedicatedServerProxy")
     ...
     *
     * @param name
     * @return eg "mineEngine:myblockname"
     */
